...
#define CONFIG_PRISM_BENCH_REGISTER_CLI 1
#define CONFIG_PRISM_BENCH_PATTERN_PALETTE 1
#define CONFIG_PRISM_METRICS_HTTP 1
#define CONFIG_PRISM_METRICS_CLI 1
#define CONFIG_PRISM_METRICS_PROMETHEUS 1
